                        ...
                        if (tempFile.exists()) {
                            ...
                            for (int z = 0; z != op_count; z++) {
                                ...
                                for (int i = 0; i != num_threads; i++) {
                                    mainFrame.put = new Put(upload, mainFrame.cred.getAccess_key(), mainFrame.cred.getSecret_key(), mainFrame.cred.getBucket(), mainFrame.cred.getEndpoint(), "test_" + i, false, false);
                                    mainFrame.put.startc(upload, mainFrame.cred.getAccess_key(), mainFrame.cred.getSecret_key(), mainFrame.cred.getBucket(), mainFrame.cred.getEndpoint(), "test_" + i, false, false);
                                }
