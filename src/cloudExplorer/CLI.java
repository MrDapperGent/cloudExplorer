                        ...
                        try {
                            ...
                            if (folder != null) {
                                if (object_array[i].contains(folder)) {
                                    ...
                                    String object = makeDirectory(destination + File.separator + cutit[0] + File.separator + transcoded_object + File.separator + cutit[cutit.length - 2]);
                                    //String object = makeDirectory(destination + File.separator + cutit[0]);
                                    System.out.print("\nDebug making dir:" + destination + File.separator + cutit[0] + File.separator + transcoded_object + File.separator + cutit[cutit.length - 2]);
