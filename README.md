...
# Description 
Cloud Explorer is a simple, free, and open-source S3 client. It works on Windows, Linux, and Mac and contains a graphical and command line interface.
...
If you want to use the Cloud Explorer CLI instead of the GUI, please run the container as shown below:
	...
	2. java -jar /cloudExplorer-5.17/CloudExplorer.jar help
