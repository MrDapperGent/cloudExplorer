...
To upgrade, please use the updater located in the application. Everytime Cloud Explorer is ran, it will check for the latest version. To apply the update, click "Help -> Check for updates". Some upgrades may contain newer librarys and will require that you manually download the entire release under "releases" in GitHub. Starting with version 8, you will be able to upgrade to newer releases with library changes without manually downloading the newer release from this site. Since there is no upgrade path from version 7 to 8, you will need to  download the version 8 release. 
