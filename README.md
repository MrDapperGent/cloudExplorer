...
# Important Advisory
Version 6.x no longer works with Amazon Web Services. v7 is coming out soon to address this issue and will only work with v4 singing. This was related to a problem with Java and the AWS JDK. In-place upgrading from v6 to v7 is not supported. Please download the complete v7 release.
